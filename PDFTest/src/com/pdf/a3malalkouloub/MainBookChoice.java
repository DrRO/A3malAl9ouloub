...
import com.pdf.a3malalkouloub.externals.Book;
...
public class MainBookChoice extends MySuperScaler implements OnClickListener {
	...
	public static void setMargins (View v, View srcView, int myNewX, int myNewY) {
		...
		if(!isTablet)
			absParams.bottomMargin = (int)(screen_height - myNewY + srcView.getHeight() - 0.435 * screen_height);
		else
			absParams.bottomMargin = (int)(screen_height - myNewY + srcView.getHeight() - 0.255 * screen_height);
